...
C-------------------------------------------------------------------
      SUBROUTINE XFERSUM(EGRTYPE,ACCMDE,DC,SC2,TRIPS,RTEMP,RTEMP2,
     *                   RTEMP3)
      INCLUDE 'stadat.com'
      INCLUDE 'param.com'
...
C
      ...
      REAL*8      TRIPS,RTEMP,RTEMP2,RTEMP3
...
C..............................................................................
      ...
      WRITE(64,1000) T,(DC+MAX_IZONES),STANAME(DC),(SC2+MAX_IZONES),
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,1)=STASUM7(SC2,3,1)+RTEMP2
      STASUM7(SC2,4,1)=STASUM7(SC2,4,1)+RTEMP3
      STASUM7(SC2,2,1)=STASUM7(SC2,2,1)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,2)=STASUM7(SC2,3,2)+RTEMP2
      STASUM7(SC2,4,2)=STASUM7(SC2,4,2)+RTEMP3
      STASUM7(SC2,2,2)=STASUM7(SC2,2,2)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
      IF(STANUM(TX1).EQ.STANUM(TX2)) CYCLE
C...PRODUCTION END
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,3)=STASUM7(SC2,3,3)+RTEMP2
      STASUM7(SC2,4,3)=STASUM7(SC2,4,3)+RTEMP3
      STASUM7(SC2,2,3)=STASUM7(SC2,2,3)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
      IF(STANUM(TX1).EQ.STANUM(TX2)) CYCLE
C...PRODUCTION END
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,4)=STASUM7(SC2,3,4)+RTEMP2
      STASUM7(SC2,4,4)=STASUM7(SC2,4,4)+RTEMP3
      STASUM7(SC2,2,4)=STASUM7(SC2,2,4)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
      IF(STANUM(TX1).EQ.STANUM(TX2)) CYCLE
C...PRODUCTION END
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,5)=STASUM7(SC2,3,5)+RTEMP2
      STASUM7(SC2,4,5)=STASUM7(SC2,4,5)+RTEMP3
      STASUM7(SC2,2,5)=STASUM7(SC2,2,5)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
      IF(STANUM(TX1).EQ.STANUM(TX2)) CYCLE
C...PRODUCTION END
...
C...INITIAL AND FINAL BOARDING/ALIGHTING
      ...
      STASUM7(SC2,3,6)=STASUM7(SC2,3,6)+RTEMP2
      STASUM7(SC2,4,6)=STASUM7(SC2,4,6)+RTEMP3
      STASUM7(SC2,2,6)=STASUM7(SC2,2,6)+(TRIPS-RTEMP-RTEMP2-RTEMP3)
      END IF
      IF(STANUM(TX1).EQ.STANUM(TX2)) CYCLE
C...PRODUCTION END
