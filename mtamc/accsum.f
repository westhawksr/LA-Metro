...
C...WALK ACCESS STATIONS
      ...
      IF(IMODE.EQ.1) THEN
       ...
       XTRIPS(75,JZ)=XTRIPS(75,JZ)+TRIPS(ISTA) 
       ELSE 
      ...
      IF(IMODE.EQ.2) XTRIPS(76,JZ)=XTRIPS(76,JZ)+TRIPS(ISTA)
      ELSE
...
C...BUS ACCESS STATIONS
      ...
      IF(IMODE.EQ.1) THEN
       ...
       XTRIPS(75,JZ)=XTRIPS(75,JZ)+TRIPS(ISTA+2) 
       ELSE 
     ...
     *     TRIPS(ISTA+2)
      ...
      IF(IMODE.EQ.2) XTRIPS(76,JZ)=XTRIPS(76,JZ)+TRIPS(ISTA+2)
      ELSE
       IF(STANUM(SC2).EQ.2) THEN                                     !BRT --> Urban Rail
...
C...PNR ACCESS STATIONS
      ...
      IF(IMODE.EQ.1) THEN
       ...
       XTRIPS(75,JZ)=XTRIPS(75,JZ)+TRIPS(ISTA+4) 
       ELSE 
     ...
     *     TRIPS(ISTA+4)
      ...
      IF(IMODE.EQ.2) XTRIPS(76,JZ)=XTRIPS(76,JZ)+TRIPS(ISTA+4)
      ELSE
       IF(STANUM(SC2).EQ.2) THEN                                     !BRT --> Urban Rail
...
C...KNR ACCESS STATIONS
      ...
      IF(IMODE.EQ.1) THEN
       ...
       XTRIPS(75,JZ)=XTRIPS(75,JZ)+TRIPS(ISTA+8) 
       ELSE 
     ...
     *     TRIPS(ISTA+8)
      ...
      IF(IMODE.EQ.2) XTRIPS(76,JZ)=XTRIPS(76,JZ)+TRIPS(ISTA+8)
      ELSE
       IF(STANUM(SC2).EQ.2) THEN                                     !BRT --> Urban Rail
...
C...BIKE ACCESS STATIONS
      ...
      IF(IMODE.EQ.1) THEN
       ...
       XTRIPS(75,JZ)=XTRIPS(75,JZ)+TRIPS(ISTA+12) 
       ELSE 
     ...
     *     TRIPS(ISTA+12)
      ...
      IF(IMODE.EQ.2) XTRIPS(76,JZ)=XTRIPS(76,JZ)+TRIPS(ISTA+12)
      ELSE
       IF(STANUM(SC2).EQ.2) THEN                                      !BRT --> Urban Rail
