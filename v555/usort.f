...
C-------------------------------------------------------------------
      SUBROUTINE USORT(NNDEX,UTIL,STA,ISTA,DSTA,DUTIL,CRPNR,CRPNR2,
     *                imode)
       INCLUDE 'stadat.com'
       INCLUDE 'param.com'
...
C
  160 CSORT=.FALSE.
      DO 161 JZ=2,10
      IF(UTIL(IMODE,JZ).LT.UTIL(IMODE,JZ-1)) THEN
      TJZ=NNDEX(IMODE,JZ)
      QJZ=DSTA(imode,JZ)
      TUTIL=UTIL(IMODE,JZ)
...
C...................................................................
      IF(DEBUG) THEN
      WRITE(26,9031) NAME(IMODE) 
 9031 FORMAT(//1X,'UTILITY SORT BY STATION -- ',A13/
     *       1X,'------------------------')
      DO 9032 IX=1,10
 ...
 9033 FORMAT(1X,'UTIL(',I4,'-->',I4')=',F8.2,' MODEL UTIL=',F8.2,
     *       5X,A37)
 9032 CONTINUE
      END IF
C....................................................................
