...
C-------------------------------------------------------------------
     ...
     *                    STASTA,STAZNE,HTIME,HDIST,IMODE,STAEGR,ZHHD,
     *                    UBERUTIL,UBERCOST)
       INCLUDE 'stadat.com'
       INCLUDE 'param.com'
     ...
     *              STAZNE(4,MAX_STATIONS,MAX_IZONES)
      ...
      REAL*4        UBERCOST,UBERACC,KWAIT,UBERUTIL
      REAL*4        TIMUTIL,OPCUTIL,STAUTIL
...
C.....................................................................
 ...
 9027 FORMAT(/1X,'KISS&RIDE ACCESS #',I2,
     ...
     *       1X,'STA-->ZNE UTILITY   =',F10.5//
     *       1X,'HIGHWAY ACCESS TIME =',F10.5/
     *       1X,'HIGHWAY ACCESS UTIL =',F10.5/
     *       1X,'HIGHWAY ACCESS DIST =',F10.2/
     *       1X,'HIGHWAY OPCOST UTIL =',F10.5//
     *       1X,'PLATFORM ACCESS TIME=',F10.5/
     *       1X,'ACCESS STA IVT  TIME=',F10.5/
     *       1X,'PLATFORM EGRESS TIME=',F10.5/
     *       1X,'EGRESS STA WALK TIME=',F10.5/
...
C
      IF(UBERTRN.AND.TRNEGR) THEN
      CALL UBERCOMP(IZ,HTIME(PSTA),HDIST(PSTA),COEFF(3),COEFF(2),
     *              UBERCOST,UBERACC,KWAIT,ZHHD)
      STAUTIL=COEFF(7) * (STADATA(IC,13) + STAWLK + EGRWALK) +
     *        COEFF(1) * (EGRIVT + STADATA(IC,14))
      UBERUTIL=STASTA(1,IC,DC) + STAEGR(3,DC,JZ) + 
     *        +STAUTIL + UBERACC
C.....................................................................
      IF(DEBUG.AND.TRNEGR) THEN
      WRITE(26,9039) IX,NAME(IMODE),IZ,JZ,
     *               PSTA,PDSTA,
     *               HDIST(PSTA),KWAIT,UBERCOST,
     *               STASTA(1,IC,DC),STAEGR(3,DC,JZ),
     *               STAUTIL,
     *               UBERACC,UBERUTIL
